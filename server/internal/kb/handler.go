...
func (h *Handler) Create(c *fiber.Ctx) error {
	...
	k, err := h.svc.Create(c.Context(), middleware.TenantID(c), middleware.UserID(c), in)
	if err != nil {
...
func (h *Handler) Get(c *fiber.Ctx) error {
	k, err := h.svc.Get(c.Context(), middleware.TenantID(c), c.Params("id"))
	if err != nil {
		return response.Fail(c, err)
	}
	return response.OK(c, k)
}
...
func (h *Handler) Update(c *fiber.Ctx) error {
	...
	k, err := h.svc.Update(c.Context(), middleware.TenantID(c), c.Params("id"), in)
	if err != nil {
		return response.Fail(c, err)
	}
	return response.OK(c, k)
...
func (h *Handler) SetVisibility(c *fiber.Ctx) error {
	...
	if err := h.svc.SetVisibility(c.Context(), middleware.TenantID(c), c.Params("id"), body.Visibility); err != nil {
		return response.Fail(c, err)
	}
	return response.OK(c, fiber.Map{"visibility": body.Visibility})
}
